...
type Storage interface {
	...
	CreateMoviePick(ctx context.Context, pick *v1.MoviePick) error
	GetMoviePick(ctx context.Context, id string) (*v1.MoviePick, error)
	ListMoviePicks(ctx context.Context, clubID string) ([]*v1.MoviePick, error)
	DeleteMoviePick(ctx context.Context, id string) error
